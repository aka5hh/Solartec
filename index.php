                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
                                <h1 class="display-2 text-black animated slideInDown"><?= $banner['ban_title'];?></h1>
                                <p class="fs-5 fw-medium text-white mb-4 pb-3"><?= $banner['ban_subtitle'];?></p>
                                <a href="" class="btn btn-primary rounded-pill py-3 px-5 animated slideInLeft"><?= $banner['ban_button'];?></a>
                            </div>
                        </div>
                    </div>
                </div>
