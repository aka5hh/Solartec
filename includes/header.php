...
<head>
    ...
    <link href="css/font_bootstrap-icons.css" rel="stylesheet">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        <a href="admin/index.php" class="navbar-brand d-flex align-items-center border-end px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="quote.php" class="btn btn-primary rounded-0 py-4 px-lg-5 d-none d-lg-block <?php if($page=='quote.php') {echo 'active';}?> ">Get A Quote<i class="fa fa-arrow-right ms-3"></i></a>
        </div>
    </nav>