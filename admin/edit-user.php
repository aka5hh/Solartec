...
if (!empty($_POST)) {
  ...
  $update = "UPDATE user SET user_name='$name', user_phone='$phone', user_email='$email', role_id='$role' WHERE user_id='$id'";
      ...
      if (!empty($role)) {
        if (mysqli_query($con, $update)) {
          if ($image['name'] != '') {
            ...
            $updimg = "UPDATE user SET user_photo='$imageName'WHERE user_id='$id'";
        ...
        <div class="card-header">
          <div class="row">
            <div class="col-md-8 card_title_part">
              <i class="fab fa-gg-circle"></i>Update Registration Information
            </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-2">
              <?php if ($data['user_photo'] != "") { ?>
                <img height="100" class="img200" src="uploads/<?= $data['user_photo'] ?> " alt="User" />
              <?php } else { ?>
                <img height="100" src="images/avatar.jpg" alt="User" />
              <?php } ?>
            </div>
          </div>
        </div>
